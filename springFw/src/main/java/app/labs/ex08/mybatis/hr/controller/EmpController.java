...
import app.labs.ex08.mybatis.hr.service.EmpService;
...
public class EmpController {
    ...
    @PostMapping("/update")
    public String updateEmpPost(EmpVO emp, RedirectAttributes rttr) {
        // managerId가 0이면 null 처리
        ...
        if (result > 0) {
            ...
            rttr.addFlashAttribute("message", "사원 수정에 실패했습니다");
        }
